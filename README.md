...
```
futhark bench --backend=opencl test-scan-mm5.fut --pass-option=--default-group-size=512
futhark bench --backend=cuda test-scan-mm5.fut --futhark=~/futhark
futhark bench --backend=cuda test-scan-mm5.fut
